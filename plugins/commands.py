...
async def start(client, message):
    if message.chat.type in ['group', 'supergroup']:
        buttons = [
            [
                InlineKeyboardButton('🤖 Updates', url=f"https://t.me/joinchat/VtTZc5al3Vt0te9_")
            ]
            ]
    ...
    if len(message.command) != 2:
        buttons = [[            
            InlineKeyboardButton('⚙️ Jᴏɪɴ Oᴜʀ Oғғɪᴄɪᴀʟ Cʜᴀɴɴᴇʟ ⚙️', url='https://t.me/joinchat/VtTZc5al3Vt0te9_')
            ]]     
        reply_markup = InlineKeyboardMarkup(buttons)        
